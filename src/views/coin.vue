<template>
  <div>
    ...
    <div class="coin">
      ...
      <svg v-if="data.changePercent24Hr >'0'" width="50" height="50" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title>ionicons-v5-c</title><polyline points="352 144 464 144 464 256" style=